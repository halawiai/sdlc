...
export interface ProcessFlowV2CanvasProps {
...
const ProcessFlowV2Canvas: React.FC<ProcessFlowV2CanvasProps> = ({
  getPhase,
  onSelect,
}) => {
  useEffect(() => {
    console.log("%c[ProcessFlowV2Canvas] mounted v2.3", "color:#2563eb;font-weight:bold");
  }, []);
...
export default ProcessFlowV2Canvas;