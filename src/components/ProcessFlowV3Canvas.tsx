...
export interface ProcessFlowV3CanvasProps {
...
const ProcessFlowV3Canvas: React.FC<ProcessFlowV3CanvasProps> = ({
  getPhase,
  onSelect,
}) => {
  useEffect(() => {
    console.log("%c[ProcessFlowV3Canvas] mounted v3.0 - NEW COMPONENT", "color:#10b981;font-weight:bold");
  }, []);
...
export default ProcessFlowV3Canvas;